...
import { ArrowRight, Eye, EyeOff, Check, Github } from 'lucide-react';
    ...
    <div className="min-h-screen w-full flex">
      ...
      <div className="flex-1 min-h-screen flex items-center justify-center bg-white">
        <div className="w-[400px] space-y-8">
          {/* 表单头部 */}
          <div className="space-y-2">
            <h2 className="text-[32px] font-bold text-text-primary font-display">欢迎回来</h2>
            <p className="text-[15px] text-text-secondary">请登录您的账号继续使用</p>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <span className="text-[13px] text-slate-400">或者</span>
            <div className="flex-1 h-px bg-border" />
          </div>
          ...
          <div className="space-y-3">
            <button
              ...
              className="w-full h-12 rounded-xl border border-border text-sm font-medium text-slate-700 hover:bg-slate-50 transition-colors flex items-center justify-center gap-2.5"
            >
